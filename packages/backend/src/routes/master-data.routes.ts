...
router.use('/regions', createCrudRouter({
  modelName: 'region',
  tableName: 'regions',
...
router.use('/cities', createCrudRouter({
  modelName: 'city',
  tableName: 'cities',
...
router.use('/ports', createCrudRouter({
  modelName: 'port',
  tableName: 'ports',
...
router.use('/uoms', createCrudRouter({
...
router.use('/warehouse-types', createCrudRouter({
...
router.use('/equipment-types', createCrudRouter({
...
router.use('/employees', createCrudRouter({
  modelName: 'employee',
  tableName: 'employees',
...
router.use('/warehouses', createCrudRouter({
  modelName: 'warehouse',
...
router.use('/items', createCrudRouter({
  modelName: 'item',
  tableName: 'items',
...
router.use('/generators', createCrudRouter({
  modelName: 'generator',
...
router.use('/equipment-fleet', createCrudRouter({
...
router.use('/supplier-rates', createCrudRouter({
...
router.use('/inventory', createCrudRouter({
...
router.use('/customs', createCrudRouter({
