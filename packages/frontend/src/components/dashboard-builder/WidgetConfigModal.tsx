...
const DATA_SOURCES = [
  ...
  { value: 'grouped/mrrv_by_status', label: 'MRRV by Status' },
  { value: 'grouped/mirv_by_status', label: 'MIRV by Status' },
  ...
  { value: 'table/recent_mrrv', label: 'Recent MRRV' },
  { value: 'table/recent_mirv', label: 'Recent MIRV' },
