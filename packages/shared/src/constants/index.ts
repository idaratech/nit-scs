...
export const MIRV_APPROVAL_LEVELS: ApprovalLevel[] = [
  { level: 1, label: 'Level 1 - Storekeeper', roleName: 'warehouse_staff', minAmount: 0, maxAmount: 10_000, slaHours: 4 },
  { level: 2, label: 'Level 2 - Logistics Manager', roleName: 'logistics_coordinator', minAmount: 10_000, maxAmount: 50_000, slaHours: 8 },
  { level: 3, label: 'Level 3 - Department Head', roleName: 'manager', minAmount: 50_000, maxAmount: 100_000, slaHours: 24 },
  { level: 4, label: 'Level 4 - Operations Director', roleName: 'manager', minAmount: 100_000, maxAmount: 500_000, slaHours: 48 },
...
export const JO_APPROVAL_LEVELS: ApprovalLevel[] = [
  { level: 1, label: 'Level 1 - Logistics Coordinator', roleName: 'logistics_coordinator', minAmount: 0, maxAmount: 5_000, slaHours: 4 },
  { level: 2, label: 'Level 2 - Logistics Manager', roleName: 'manager', minAmount: 5_000, maxAmount: 20_000, slaHours: 8 },
  { level: 3, label: 'Level 3 - Operations Director', roleName: 'manager', minAmount: 20_000, maxAmount: 100_000, slaHours: 24 },
